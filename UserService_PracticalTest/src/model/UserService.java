...
public class UserService {
	...
	public String insertUserDetails(String fname, String lname, String nic, String address, String phone, String email, String username, String password, String type) {
		...
		String result = "";
			...
			catch(Exception e) 
			{
				...
				result = "{\"status\":\"error\", \"data\":\"Error while inserting the user.\"}";
	...
	public String readUserDetails() {
		...
		try {
			...
			result = "<table class='table table-striped' border = '1'> <tr><th>First Name</th> "
					+ "<th>Last Name</th>"
					+ "<th>NIC</th> "
					+ "<th>Address</th> "
					+ "<th>Phone</th> "
			...
			while (rs.next()) 
			{
				...
				result += "<td><input name='btnUpdate' type='button' value='Update' "
						 + "class='btnUpdate btn btn-success' data-user ='" + userID + "'></td>"
						 + "<td><input name='btnRemove' type='button' value='Remove' "
						 + "class='btnRemove btn btn-danger' data-user ='" + userID + "'></td></tr>";
	...
	public String updateUserDetails(String userID, String fname, String lname, String nic, String address, String phone, String email, String username, String password) {
		...
		String result = "";
			...
			catch(Exception e) 
			{
				...
				result = "{\"status\":\"error\", \"data\":\"Error while updating the user.\"}";
				 System.err.println(e.getMessage()); 
	...
	/*public String readUserType(String type) {
		...
		try {
			...
			while (rs.next()) 
			{
				...
				result += "<td><input name='btnUpdate' type='button' value='Update' "
						 + "class='btnUpdate btn btn-secondary' data-userID ='" + user + "'></td>"
						 + "<td><input name='btnRemove' type='button' value='Remove' "
						 + "class='btnRemove btn btn-danger' data-userID ='" + user + "'></td></tr>";
